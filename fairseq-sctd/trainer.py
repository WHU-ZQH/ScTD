...
class Trainer(object):
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        # rank=None
        # if (self.get_num_updates() / self.cfg.optimization.max_update) < 0.1 :
        #     rank=None
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.26 :
        #     rank=0
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.42 :
        #     rank=1
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.58 :
        #     rank=2
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.74 :
        #     rank=3
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.9 :
        #     rank=4
        # else:
        #     rank=None

        # rank=None
        # if (self.get_num_updates() / self.cfg.optimization.max_update) < 0.05 :
        #     rank=None
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.2 :
        #     rank=0
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.35 :
        #     rank=1
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.5 :
        #     rank=2
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.65 :
        #     rank=3
        # elif (self.get_num_updates() / self.cfg.optimization.max_update) < 0.8 :
        #     rank=4
        # else:
        #     rank=None
